...
@section('title') {{ trans('admin.delete' ,['name' =>trans('admin.order')]) }} @endsection
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">{{ trans('admin.delete' ,['name' =>trans('admin.order')]) }}</h3>
            </div>
